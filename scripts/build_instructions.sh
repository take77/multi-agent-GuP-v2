...
build_instruction_file "claude" "captain" "captain.md"
build_instruction_file "claude" "vice_captain" "vice_captain.md"
build_instruction_file "claude" "member" "member.md"

# Build Codex instruction files
build_instruction_file "codex" "captain" "codex-captain.md"
build_instruction_file "codex" "vice_captain" "codex-vice_captain.md"
build_instruction_file "codex" "member" "codex-member.md"

# Build Copilot instruction files
build_instruction_file "copilot" "captain" "copilot-captain.md"
build_instruction_file "copilot" "vice_captain" "copilot-vice_captain.md"
build_instruction_file "copilot" "member" "copilot-member.md"

# Build Kimi K2 instruction files
build_instruction_file "kimi" "captain" "kimi-captain.md"
build_instruction_file "kimi" "vice_captain" "kimi-vice_captain.md"
build_instruction_file "kimi" "member" "kimi-member.md"
