...
const AGENT_NAMES: Record<string, string> = {
  anzu: "あんず", miho: "みほ",
  darjeeling: "ダージリン", pekoe: "ペコ", hana: "華",
  rosehip: "ローズヒップ", marie: "マリー", andou: "安藤", oshida: "押田",
  katyusha: "カチューシャ", nonna: "ノンナ", klara: "クラーラ",
  mako: "麻子", erwin: "エルヴィン", caesar: "カエサル", saori: "沙織",
  kay: "ケイ", arisa: "アリサ", naomi: "ナオミ",
  yukari: "優花里", anchovy: "アンチョビ", pepperoni: "ペパロニ", carpaccio: "カルパッチョ",
  maho: "まほ", erika: "エリカ", mika: "ミカ",
  aki: "アキ", mikko: "ミッコ", kinuyo: "絹代", fukuda: "福田",
};
