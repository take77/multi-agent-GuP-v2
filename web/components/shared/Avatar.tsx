...
const AVATARS: Record<string, AvatarDef> = {
  ...
  nonna: { bg: "bg-slate-400", ini: "Н", ring: "ring-slate-300", objectPosition: "50% 15%" },
  ...
  carpaccio: { bg: "bg-emerald-300", ini: "カ", ring: "ring-emerald-200", objectPosition: "50% 15%" },
  // まほ隊
  ...
  aki: { bg: "bg-teal-300", ini: "ア", ring: "ring-teal-200", objectPosition: "50% 15%" },
  mikko: { bg: "bg-cyan-300", ini: "ミッ", ring: "ring-cyan-200", objectPosition: "50% 15%" },
  kinuyo: { bg: "bg-purple-300", ini: "絹", ring: "ring-purple-200", objectPosition: "50% 15%" },
